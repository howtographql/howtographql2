...
const options: TypographyOptions = {
  ...
  scaleRatio: 2,
  bodyColor: styledTheme.editorColors.text,
  headerWeight: 600,
  bodyWeight: 'normal',
  boldWeight: 600,
  ...
  overrideStyles: ({ rhythm }) => ({
    ...
    h2: {
      ...
      color: styledTheme.editorColors.string,
    },
    h3: {
      color: styledTheme.editorColors.string,
    },
    ...
    h5: {
      color: styledTheme.editorColors.string2,
    },
    h6: {
      color: styledTheme.editorColors.text,
    },
    'h2,h3,h4,h5': {
      fontFamily:
    ...
    a: {
      color: styledTheme.editorColors.property,
      textDecoration: 'none',
    },
    'a:hover,a:active': {
      color: styledTheme.editorColors.property,
    ...
    blockquote: {
      borderLeft: `4px solid ${styledTheme.editorColors.string}`,
      color: styledTheme.editorColors.text,
      marginTop: 0,
      marginRight: 0,
      marginLeft: 0,
    ...
    'tt,code': {
      backgroundColor: styledTheme.editorColors.resultBackground,
      borderRadius: '3px',
      fontFamily:
        '"Source Code Pro", "SFMono-Regular", Consolas,"Roboto Mono","Droid Sans Mono","Liberation Mono",Menlo,Courier,monospace',
    ...
    pre: {
      background: styledTheme.editorColors.resultBackground,
      borderRadius: '3px',
      lineHeight: 1.42,
      overflow: 'auto',
